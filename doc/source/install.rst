...
`/opt` and create symlinks into `/usr/local/bin`::
  ...
  wget https://github.com/epruesse/SINA/releases/download/v1.7.1/sina-1.5.0-linux.tar.gz
  sudo tar xf sina-1.7.1-linux.tar.gz -C /opt
  rm sina-1.7.1-linux.tar.gz
  sudo ln -s /opt/sina-1.7.1-linux /opt/sina
